<div class="flex w-full flex-col gap-4 p-3 sm:p-4 lg:p-6">
    <div>
        <flux:heading size="lg" level="1">{{ __('snippet_templates.create_title') }}</flux:heading>
    </div>
    ...
    <form wire:submit="save" class="flex flex-col gap-3 rounded-lg border border-zinc-200 bg-white p-4 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <div class="flex justify-end">
            <flux:button size="xs" variant="ghost" type="button" wire:click="applyLanguagePreset">
                {{ __('snippet_templates.apply_language_preset') }}
            </flux:button>
        </div>
